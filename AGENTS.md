...
5. Peer Review: Address and proactively resolve actionable review comments left by CodeRabbit on open PRs prior to human merge. Always reply directly to each review comment thread on GitHub with the resolving commit reference so CodeRabbit can confirm and resolve the thread or provide further feedback.
