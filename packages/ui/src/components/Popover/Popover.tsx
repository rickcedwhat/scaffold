...
export interface PopoverContentProps
  extends Omit<ComponentPropsWithoutRef<typeof RadixPopover.Content>, 'className' | 'style'> {
...
export function PopoverAnchor({ asChild = true, children }: PopoverAnchorProps) {
